...
#ifndef _HEADER_ADAPTOR_SYNAPSE_ENUM_HH_
# define _HEADER_ADAPTOR_SYNAPSE_ENUM_HH_
...
public:
   ...
   */
  static std::string adapt(IFile& file, const EnumDescriptor *desc);
   ...
   * @return an empty string on success, an explanation on error
   */
  static std::string adapt(IFile& file, const EnumValueDescriptor *desc);
};
...
#endif /* !_HEADER_ADAPTOR_SYNAPSE_ENUM_HH_ */
