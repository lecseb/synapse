...
#ifndef _AST_SERVICE_ALLOCATOR_SYNAPSE_NEW_HH_
# define _AST_SERVICE_ALLOCATOR_SYNAPSE_NEW_HH_
 ...
 */
class function_new : public decl, public function {
public:
  /**
   * @brief Constructor
   * @param [in] desc: protobuf service descriptor structure
   */
  explicit function_new(const google::protobuf::MethodDescriptor *desc);
