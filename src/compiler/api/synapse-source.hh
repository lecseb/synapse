...
#ifndef _API_SYNAPSE_SOURCE_HH_
# define _API_SYNAPSE_SOURCE_HH_
...
class source : public file::source {
public:
  /**
   * @brief Constructor
   ...
   */
  virtual void visite(stream&, const ast::enumeration *) {
    /* nothing to do here */
  }
